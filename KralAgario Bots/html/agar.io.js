...
drawTc("Freeze = T", 310, 158)
  ...
  function drawBase(e, t, n) {
    button = new Ga(24, "#FFFFFF"), button.r(e);
    var o = button.B(),
      a = o.width,
      i = o.height;
    f.globalAlpha = .2, f.fillStyle = "yellow", f.fillRect(0 + t, i - 28 + n, a + 150, 220), f.globalAlpha = 1, f.drawImage(o, 5 + t, i - 23 + n)
  ...
  function drawText(e, t, n) {
    ...
    var o = button.B(),
      a = o.width,
      i = o.height;
    f.globalAlpha = .2, f.fillStyle = "transparent", f.fillRect(0 + t, i - 28 + n, a + 245, 250), f.globalAlpha = 1, f.drawImage(o, 5 + t, i - 23 + n)
  ...
  function drawBorders(e) {
    Ea && (e.strokeStyle = "red"), e.beginPath(), e.moveTo(za, Aa), e.lineTo(Ba, Aa), e.lineTo(Ba, Ca), e.lineTo(za, Ca), e.lineTo(za, Aa), e.stroke()
  }
